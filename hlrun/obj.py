...
class HlString(HlObj):
    ...
    def toUpperCase(self) -> "HlString":
        ...
        """
        return self.__getattr__("toUpperCase")(self)
    def toLowerCase(self) -> "HlString":
        """
        Returns a String where all characters of `this` String are lower case.
        """
        return self.__getattr__("toLowerCase")(self)
    def charAt(self, index: int) -> "HlString":
        ...
        """
        return self.__getattr__("charAt")(self, index)
    def charCodeAt(self, index: int) -> Optional[int]:
        ...
        """
        return self.__getattr__("charCodeAt")(self, index)
    def findChar(self, start: int, len: int, src: HlObj, srcLen: int) -> int:
        ...
        """
        return self.__getattr__("findChar")(self, start, len, src, srcLen)
    def indexOf(self, str: "HlString", startIndex: Optional[int]) -> int:
        ...
        """
        return self.__getattr__("indexOf")(self, str, startIndex)
    def lastIndexOf(self, str: "HlString", startIndex: Optional[int]) -> int:
		...
		If `str` cannot be found, -1 is returned.
        """
        return self.__getattr__("lastIndexOf")(self, str, startIndex)
    def split(self, delimiter: "HlString") -> List[HlString]:
        ...
        """
        return self.__getattr__("split")(self, delimiter)
    def substr(self, pos: int, len: Optional[int]) -> HlString:
        ...
        """
        return self.__getattr__("substr")(self, pos, len)
    def substring(self, startIndex: int, endIndex: Optional[int]) -> HlString:
		...
		String `""` is returned.
        """
        return self.__getattr__("substring")(self, startIndex, endIndex)
    def toString(self) -> HlString:
        """
        Returns the String itself.
        """
        return self.__getattr__("toString")(self)
    def fromCharCode(self, code: int) -> HlString:
		...
		unspecified.
        """
        return self.__getattr__("fromCharCode")(self, code)
