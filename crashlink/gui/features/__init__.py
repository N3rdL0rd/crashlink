...
from . import exports, file_info, globals_window, hlasm_edit, internals, lookups, strings_window

if TYPE_CHECKING:
    from ..main_window import MainWindow

_FEATURES = (strings_window, globals_window, file_info, internals, exports, lookups, hlasm_edit)
